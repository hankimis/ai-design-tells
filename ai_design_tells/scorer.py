...
def _load_calib():
    ...
    if _CALIB_CACHE is None:
        ...
        # prefer the repo's freshly-generated data in dev; fall back to the copy
        # bundled inside the installed package.
        path = os.path.join(pkg, "data", "calibration.json")
        repo = os.path.join(pkg, "..", "data", "calibration.json")
